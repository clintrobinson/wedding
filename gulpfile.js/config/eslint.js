...
module.exports = {
  ...
  eslintcfg: {
     ...
     */
      ...
      'no-console': false,             // webpack is setup to automatically strip out console.logs
                                       // when we run `gulp --prod` instead of `gulp --dev`
                                       // http://eslint.org/docs/rules/no-console

      'no-debugger': 1,                // disallow use of debugger
                                       // http://eslint.org/docs/rules/no-debugger

      'no-alert': false,                   // http://eslint.org/docs/rules/no-alert
      ...
      'no-unused-expressions': false,  // disallow unused expressions
                                       // becuase of our DEBUG && console.log() functionality,
                                       // we have to turn this off so that we can do conditional
                                       // stripping of console.logs
     ...
     */
      ...
      'no-loop-func': false,               // disallow creation of functions within loops
      ...
      'vars-on-top': false,                // requires to declare all vars on top of their containing scope (off by default)
     ...
     */
      ...
      'func-names': false,                 // require function expressions to have a name (off by default)
      ...
      'padded-blocks': false,          // enforce padding within blocks (off by default)
